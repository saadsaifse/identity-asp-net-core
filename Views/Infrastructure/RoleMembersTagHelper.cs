...
namespace AspIdentity.Views.Infrastructure
{
    ...
    public class RoleMembersTagHelper : TagHelper
    {
        ...
        public RoleMembersTagHelper(UserManager<AppUser> usermgr, RoleManager<IdentityRole> rolemgr)
        {
            userManager = usermgr;
            roleManager = rolemgr;
        }
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Content.SetContent(names.Count == 0 ? "No Members" : string.Join(", ", names));
        }
    }
}